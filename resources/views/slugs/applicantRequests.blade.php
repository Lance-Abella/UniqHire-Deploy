<button type="button" class="submit-btn modal-btn border-0" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Applicants</button>
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="staticBackdropLabel">Applicants</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="request-grid">
                    @forelse ($requests as $request)
                    <input type="hidden" name="job" value="{{ $listing->id }}">
                        ...
                        <a href="{{ route('show-profile', $request->user->id) }}">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="text-end btn-container">
                                    ...
                                    <form action="{{ route('employer-deny', $request->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
